...
keymap("i", "jp", "<ESC>la", opts)
-- keymap("i", "ji", "<ESC>la, \"\"<ESC>i", opts)
...
-- Maximizer
-- keymap("n", "<F9>", "<cmd>:MaximizerToggle!<CR>", opts)
-- keymap("v", "<F9>", "<cmd>:MaximizerToggle!<CR>gv", opts)
-- keymap("i", "<F9>", "<cmd>:MaximizerToggle!<CR>", opts)
